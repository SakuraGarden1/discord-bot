...
const SHOP_ITEMS = [
  ...
  { id: 2, name: '⚡ XP Boost (1hr)', price: 8000,     key: 'xp_boost' },
  { id: 3, name: '🎰 Lucky Charm',    price: 12000,    key: 'lucky_charm', count: 10 },
  { id: 4, name: '💼 Work Boost',     price: 15000,    key: 'work_boost', count: 5 },
  { id: 5, name: '🏦 Bank Expand',    price: 50000,    key: 'bank_expand' },
  { id: 6, name: '💍 Мөнгөн бөгж',   price: 5000000,  key: 'ring_silver' },
  { id: 7, name: '💎 Алтан бөгж',    price: 10000000, key: 'ring_gold' },
  { id: 8, name: '👑 Алмазан бөгж',  price: 50000000, key: 'ring_diamond' },
];
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (['rob_shield', 'xp_boost', 'bank_expand'].includes(item.key) && user.inventory[item.key]) {

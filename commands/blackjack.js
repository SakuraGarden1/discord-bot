...
function gameEmbed(title,fields,footer){const e=new EmbedBuilder().setColor(0xff69b4).setTitle(`🃏 ${title}`).addFields(fields);if(footer)e.setFooter({text:footer});return e;}
